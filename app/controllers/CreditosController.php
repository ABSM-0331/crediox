...
class CreditosController
{
    ...
    public function index(): void
    {
        if (!isset($_SESSION['usuario_id'])) {
            header('Location: /panel/public/auth/login');
            exit;
        }
    ...
    public function guardarTipo(): void
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            ...
            header('Location: /panel/public/creditos');
            exit;
        }
        ...
        header('Location: /panel/public/creditos#tipos-credito');
        exit;
    }
    ...
    public function cobrar(): void
    {
        ...
        try {
            ...
            if (!empty($resultado['success']) && !empty($resultado['historial_ids'])) {
                ...
                $resultado['ticket_url'] = '/panel/public/creditos/ver-ticket?historial=' . implode(',', (array)$resultado['historial_ids']) . '&idcredito=' . $idCredito;
            }

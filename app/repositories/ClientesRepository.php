...
class ClientesRepository
{
    ...
    public function obtenerPorId(int $idPersona): ?array
    {
        $sql = "SELECT
                    ...
                    p.activo
                FROM personas p
                WHERE p.idpersona = ? AND p.idrol = 2 AND p.activo = 1";
    ...
    public function actualizarCliente(int $idPersona, array $data): void
    {
        try {
            $sql = "UPDATE personas SET
                    ...
                    WHERE idpersona = :idpersona AND idrol = 2";
    ...
    public function eliminarCliente(int $idPersona): void
    {
        try {
            $sql = "UPDATE personas
                    SET activo = 0

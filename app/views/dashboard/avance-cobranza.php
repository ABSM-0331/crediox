<section id="dashboardAvanceCobranza" class="content-section active">
    ...
    $urlPdf = '/panel/public/dashboard/avance-cobratarios-pdf?' . http_build_query($queryPdf);
    ...
    <section id="avanceCobratariosModulo" class="form-card avance-cobros-module">
        <div class="form-section avance-cobros-header">
            ...
            <form id="avanceCobranzaForm" method="GET" action="/panel/public/dashboard/avance-cobranza" class="form-grid avance-cobros-filters">
            ...
            <div class="avance-cobros-actions-bar">
                <a href="/panel/public/dashboard/avance-cobranza" class="btn-secondary">Limpiar</a>

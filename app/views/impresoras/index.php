...
<section id="impresoras" class="content-section">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <?php if ((int)$impresora['activa'] !== 1): ?>
                                                <form action="/panel/public/impresoras/activar" method="POST">
                                                    <input type="hidden" name="idimpresora" value="<?= (int)$impresora['idimpresora'] ?>">
                                                    <button type="submit" class="btn-secondary">Activar</button>
                                                </form>
                                            <?php endif; ?>
                                            <form action="/panel/public/impresoras/eliminar" method="POST" onsubmit="return confirm('¿Eliminar impresora del catálogo?');">
                                                <input type="hidden" name="idimpresora" value="<?= (int)$impresora['idimpresora'] ?>">
    ...
    <div class="form-card">
        <div class="form-section">
                ...
                <div class="cards-grid" style="grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); margin-bottom: 14px;">
                    <?php foreach ($disponibles as $nombreDisponible): ?>
                        <div class="person-card" style="padding: 12px;">
                            ...
                            <form action="/panel/public/impresoras/guardar" method="POST">
            ...
            <form action="/panel/public/impresoras/guardar" method="POST" class="form-grid" style="grid-template-columns: 1fr auto; align-items: end;">

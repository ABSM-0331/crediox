...
<aside class="sidebar">
    <div class="sidebar-header">
        <div class="logo">
            <?php if (!empty($empresaSidebar['logo_ruta'])): ?>
                <img src="<?= $baseUrl ?>/<?= htmlspecialchars($empresaSidebar['logo_ruta']) ?>" alt="Logo empresa" class="sidebar-logo-image">
            <?php else: ?>
    ...
    <?php
    $dashboardHref = '/panel/public/dashboard';
    ...
    if ($rol === 2) {
        $dashboardHref = '/panel/public/dashboard-cliente';
    } elseif ($rol === 3) {
        $dashboardHref = '/panel/public/dashboard-cobratario#resumenCobratario';
    }
    ?>
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <?php if ($rol === 3): ?>
                <li>
                    <a href="/panel/public/dashboard-cobratario#tablaCreditosCobratario" class="nav-link" data-cobratario-nav="creditos">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <?php if ($rol === 1): ?>
                <li>
                    <a href="/panel/public/dashboard/avance-cobranza" class="nav-link <?= $isAvanceCobranza ? 'active' : '' ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <li>
                    <a href="/panel/public/dashboard-cobratario#tablaCreditosCobratario" class="nav-link <?= $isDashboardCobratario ? 'active' : '' ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                            <line x1="3" y1="9" x2="21" y2="9"></line>
                            <line x1="9" y1="16" x2="9" y2="16.01"></line>
            ...
            <?php if ($rol !== 2 && $rol !== 3): ?>
                ...
                <li>
                    <details class="nav-details" <?= $catalogosActive ? 'open' : '' ?>>
                        ...
                        <ul style="margin-left: 18px;">
                            <li>
                                <a href="/panel/public/clientes" class="nav-link <?= str_contains($currentPath, '/clientes') ? 'active' : '' ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <li>
                                <a href="/panel/public/reportes/saldos" class="nav-link <?= str_contains($currentPath, '/reportes/saldos') ? 'active' : '' ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M3 6h18M3 12h18M3 18h18"></path>
                                    </svg>
                                    <span>Reportes - Saldos</span>
                                </a>
                            </li>
                            <li>
                                <a href="/panel/public/cobratarios" class="nav-link <?= str_contains($currentPath, '/cobratarios') ? 'active' : '' ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <li>
                                <a href="/panel/public/usuarios" class="nav-link <?= str_contains($currentPath, '/usuarios') ? 'active' : '' ?>">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                                        <circle cx="9" cy="7" r="4"></circle>
                                        <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
                ...
                <li>
                    <a href="/panel/public/creditos" class="nav-link <?= str_contains($currentPath, '/creditos') ? 'active' : '' ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                            <line x1="3" y1="9" x2="21" y2="9"></line>
                            <line x1="9" y1="16" x2="9" y2="16.01"></line>
                ...
                <li>
                    <a href="/panel/public/empresa" class="nav-link <?= str_contains($currentPath, '/empresa') ? 'active' : '' ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
            ...
            <?php if ($rol !== 2): ?>
                <li>
                    <a href="/panel/public/impresoras" class="nav-link <?= str_contains($currentPath, '/impresoras') ? 'active' : '' ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="sidebar-footer">
        <a href="/panel/public/logout" class="logout-btn">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">

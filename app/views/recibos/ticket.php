...
$htmlLogo = $logoUrl !== '' ? '<img class="logo" src="https://crediox.com.mx/panel/public' . ticket_view_esc($logoUrl) . '" alt="Logo">' : '';
?>
<!DOCTYPE html>
<html lang="es">
    ...
    <script>
        ...
        window.enviarTicketCorreo = async function() {
            ...
            try {
                ...
                const response = await fetch("/panel/public/creditos/enviar-ticket", {
                    method: "POST",
                    body: formData,
                });

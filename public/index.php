...
switch ($uri) {
    ...
    case 'crear-cliente':
        ...
        break;
    case 'editar-cliente':
        (new ClientesController())->vistaEditarCliente();
        break;
    case 'actualizar-cliente':
        (new ClientesController())->actualizarCliente();
        break;
    case 'eliminar-cliente':
        (new ClientesController())->eliminarCliente();
        break;
    case 'cobratarios':
    ...
    case 'crear-cobratario':
        ...
        break;
    case 'editar-cobratario':
        (new CobratarioController())->vistaEditarCobratario();
        break;
    case 'actualizar-cobratario':
        (new CobratarioController())->actualizarCobratario();
        break;
